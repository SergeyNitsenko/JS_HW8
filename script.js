...

{
    ...
    let backgroundCard2 = document.getElementsByClassName('card');
    backgroundCard2[1].classList.add('backgroundCard2')

    let textColor = document.getElementsByClassName('titleCard');
    textColor[1].setAttribute('class', 'textTitleCard2');

    let titleCard2Bold = document.getElementsByClassName('titleBold');
    titleCard2Bold[2].classList.add('titleCard2Bold')
    
    let textCard2 = document.getElementsByClassName('textCard');
    textCard2[1].classList.add('textCard2')
   
    let buttonCard2 = document.getElementsByClassName('button');
    buttonCard2[1].classList.add('buttonCard2')
